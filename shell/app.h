...
#if defined(BUILD_BACKEND_WAYLAND_EGL)
  std::shared_ptr<WaylandEglBackend> m_wayland_egl_backend;
#elif defined(BUILD_BACKEND_WAYLAND_VULKAN)
  std::shared_ptr<WaylandVulkanBackend> m_wayland_vulkan_backend;
#endif
...
#elif defined(BUILD_BACKEND_WAYLAND_VULKAN)
    return reinterpret_cast<Backend*>(m_wayland_vulkan_backend.get());
#endif
  }
